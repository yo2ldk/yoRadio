...
void Display::_buildPager(){
  _meta.init("\007 ", metaConf, config.theme.meta, config.theme.metabg);
  _title1.init("\007", title1Conf, config.theme.title1, config.theme.background);
  ...
  #endif
  #ifndef HIDE_HEAPBAR
    _heapbar = new SliderWidget(heapbarConf, config.theme.heap, config.theme.background, psramInit()?300000:1600 * AUDIOBUFFER_MULTIPLIER2,config.theme.heapbarout);
  #endif
  #ifndef HIDE_VOL

...
void DspCore::_clockSeconds(){
  ...
  setCursor(width()  - clockRightSpace - CHARWIDTH*3*2+2, clockTop-clockTimeHeight+1);
...
void DspCore::_clockDate(){
  ...
  setCursor(_dateleft-73, clockTop+10);
  ...
  setCursor(width() -1 - clockRightSpace - CHARWIDTH*3*2, clockTop-CHARHEIGHT*3+10);
...
void DspCore::_clockTime(){
  ...
  _timeleft = width()-clockRightSpace-CHARWIDTH*3*2-10-_timewidth;
  setTextSize(1);
  setFont(&DS_DIGI42pt7b);
  ...
  drawFastVLine(width()-clockRightSpace-CHARWIDTH*3*2-8, clockTop-clockTimeHeight, clockTimeHeight+3, config.theme.div);  /*divider vert*/
  drawFastHLine(width()-clockRightSpace-CHARWIDTH*3*2-8, clockTop-clockTimeHeight+29, 44, config.theme.div);              /*divider hor*/
